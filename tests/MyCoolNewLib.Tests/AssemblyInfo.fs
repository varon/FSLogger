...
[<assembly: AssemblyTitleAttribute("MyCoolNewLib.Tests")>]
[<assembly: AssemblyProductAttribute("MyCoolNewLib")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MyCoolNewLib.Tests"
    let [<Literal>] AssemblyProduct = "MyCoolNewLib"
